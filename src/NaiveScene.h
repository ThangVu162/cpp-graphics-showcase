...
class NaiveScene
{
    // ---- Members khai bao truoc tat ca de VS IntelliSense nhan ra ----
...
public:
    ...
    osg::ref_ptr<osg::Group> createScene()
    {
        ...
        for (int xi = 0; xi < m_cfg.gridX; ++xi)
        {
            ...
            // LOW: flat quad nhin tu tren (2 tris thay vi sphere ~320 tris)
            // Chi show mat tren → o xa nhin giong dot mau, khong "pop" qua nhieu
            ...
            float hs = std::max<float>(sx, sz) * 0.5f;
